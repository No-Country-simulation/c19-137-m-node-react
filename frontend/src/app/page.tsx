...
import EnterPasswordPage from './auth/login2/page';  
import ForgotPasswordPage from './auth/forgot/page';  // Importa la página de "ForgotPassword"
import ResetPasswordPage from './auth/reset/page';    // Importa la página de "ResetPassword"
